...
//    public boolean removeByOscarsCount(long oscarsCount) throws SQLException {
//        int prevCount = getMoviesCount();
//        PreparedStatement statement = connection.prepareStatement("DELETE FROM movies WHERE oscars_count = ?");
//        statement.setLong(1, oscarsCount);
//        statement.executeUpdate();
//        return (prevCount - getMoviesCount()) == 1;
//    }
